...
const TABS = [
  ...
  { id: "compare", num: "08", label: "Compare", i18n: "tab-btn-compare" },
  {
    ...
    num: "09",
    label: "Rivals",
    i18n: "tab-btn-competitive",
  },
  { id: "events", num: "10", label: "Events", i18n: "tab-btn-events" },
  { id: "data", num: "11", label: "Data", i18n: "tab-btn-data" },
  { id: "club", num: "12", label: "Club SAD", i18n: "tab-btn-club" },
  { id: "news", num: "13", label: "News", i18n: "tab-btn-news" },
  {
    id: "playground",
    num: "14",
    label: "Playground",
