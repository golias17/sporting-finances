// Story-mode step data, in its own module so consumers that only need the
// step list or its length (urlSync.js validates the ?story= deep-link param
// against it) don't have to import story.js — which pulls in Chart.js and
// would create a story ↔ urlSync circular import.
