...
test.describe("Accessibility Audits", () => {
  ...
  test("should not have any automatically detectable accessibility issues on the Overview tab", async ({
    page,
  }) => {
    await page.goto("/");
  ...
  test("should not have any accessibility issues in the Data tab (Table View)", async ({
    page,
  }) => {
