...
import * as pdfGen from "../../src/ui/pdfGenerator.js";
import * as charts from "../../src/charts/charts.js";
import * as playground from "../../src/features/playground.js";
...
vi.mock("../../src/features/playground.js", () => ({
  initPlayground: vi.fn(),
  drawPlaygroundCharts: vi.fn(),
}));

vi.mock("../../src/charts/charts.js", () => {
  const chartFnNames = [
    "chartHero",
    "chartNetResult",
    "chartEquity",
...
describe("app boot (main.js)", () => {
  ...
  it("reveals a scroll-animation target and stops observing it once it intersects", () => {
    ...
    capturedIntersectionCallback([{ isIntersecting: false, target }], {
      unobserve,
    });
    expect(target.classList.contains("visible")).toBe(false);
    expect(unobserve).not.toHaveBeenCalled();

    capturedIntersectionCallback([{ isIntersecting: true, target }], {
      unobserve,
    });
