import { v as Ju } from "./defaultSettingsView-BNmKHKpQ.js";
import "./urlMatch-BYQrIQwR.js";
var vi = { exports: {} },
  Zu = vi.exports,
  pa;
function mt() {
          ...
          function ul(e) {
            (e.display.scrollbars &&
              ...
              e.display.scrollbars.addClass &&
                V(e.display.wrapper, e.display.scrollbars.addClass)),
            ...
            function D(L) {
              if (L.nodeType == 1) {
                ...
                if (Z) {
                  ...
                  ae.length &&
                    (ie = ae[0].find(0)) &&
                    x($t(e.doc, ie.from, ie.to).join(a));
                  return;
                }
      ...
      (function (ct, xt) {
        (function (b) {
          ...
          function I(ne, S) {
            for (var R in ne)
              for (
                var A = S[R] || (S[R] = []), $ = ne[R], ue = $.length - 1;
                ue >= 0;
                ue--
              )
                A.unshift($[ue]);
        ...
        (function (b) {
            ...
            return {
              ...
              token: function (me, De) {
                ...
                if (
                  ...
                  for (be.type == "}" && (be = te(De)); be.type == "statement";)
                    be = te(De);
                } else
                  we == be.type
                    ? te(De)
          ...
          function V(g, y) {
            ...
            (de(y.keywords),
              ...
              j.length &&
                ((y.helperType = g[0]),
                b.registerHelper("hintWords", g[0], j)));
              ...
              for (var M = S[$.state], N = 0; N < M.length; N++) {
                ...
                if (X) {
                  (z.data.next
                    ...
                    z.data.indent &&
                      $.indent.push(A.indentation() + R.indentUnit),
          ...
          function ne(S, R) {
            return function (A, $, ue) {
              if (A.local && A.local.mode.indent)
                return A.local.mode.indent(A.localState, $, ue);
              if (
                A.indent == null ||
                A.local ||
              ...
              var G = null,
                c = function (T, C) {
                  (b.e_stop(C),
                    T &&
                      (T != V.queryText &&
                        (R(p, V, T), (V.posFrom = V.posTo = p.getCursor())),
                      G && (G.style.opacity = 1),
